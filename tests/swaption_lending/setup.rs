...
use lending_contracts::programs::swaption_lending::{
    PositionTerms, SwaptionPosition, SwaptionPositionParameters, script_hash,
};
...
pub(super) struct Fill {
    pub txid: Txid,
    pub position: SwaptionPosition,
    pub parameters: SwaptionPositionParameters,
...
pub(super) fn fill_position(
    ...
    let position = SwaptionPosition::new_filled(parameters);
