//! Regtest setup for the Swaption position covenant, v3.
//!
...
use lending_contracts::programs::swaption_lending_v3::{
    PositionParametersV3, PositionTerms, SwaptionPositionV3, script_hash,
};
...
pub(super) struct Fill {
    pub txid: Txid,
    pub position: SwaptionPositionV3,
    pub parameters: PositionParametersV3,
...
pub(super) fn fill_position(
    ...
    let parameters = PositionParametersV3 {
        collateral_asset_id,
        cash_asset_id,
    ...
    let position = SwaptionPositionV3::new_filled(parameters);
