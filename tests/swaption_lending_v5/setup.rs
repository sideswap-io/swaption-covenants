...
use lending_contracts::programs::swaption_lending_v5::{
    PositionParametersV5, PositionTerms, SwaptionPositionV5, script_hash,
};
...
pub(super) struct Fill {
    ...
    pub venue: Signer,
    pub position: SwaptionPositionV5,
    pub parameters: PositionParametersV5,
...
pub(super) fn fill_position(
    ...
    let parameters = PositionParametersV5 {
        collateral_asset_id,
        cash_asset_id,
    ...
    let position = SwaptionPositionV5::new_filled(parameters);
